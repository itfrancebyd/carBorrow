...
const VehiclePopModal: FC<VehiclePopModalProp> = ({
    ...
    return (
        <div className="bg-white w-full sm:w-1/3 h-screen absolute right-0 top-0 bottom-0 shadow-2xl overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    <div key={index} className="flex flex-col gap-1">
                                        ...
                                        {selectKeys.includes(title.key)
                                            ...
                                            <input
                                                ...
                                                className={`border border-[#26361C] ${immutableKeys.includes(title.key) ? 'bg-[#bac7b2]' : ''} px-2 py-1 rounded-sm ${isEdit ? 'cursor-pointer' : 'cursor-text'}`}
                                                onChange={(e) =>
                                                    setData((prev: any) => ({
                                                        ...prev,
                                                        [title.key]: e.target.value,
