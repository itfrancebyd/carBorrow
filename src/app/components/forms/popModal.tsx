...
const PopModalForm: FC<PopModalFormProp> = ({ currentID, closeEvent, fetchData, tableTitle, actionDelete }) => {
                ...
                <div className="pt-7">
                    ...
                    {!error && !loading && data && (
                        <div className="p-2 text-xs">
                            <button
                                className="bg-[#26361C] my-1 py-1 px-1 rounded-sm cursor-pointer"
                            ...
                            <form className="flex flex-col gap-2">
                                ...
                                <button className="bg-[#26361C] text-white py-1 cursor-pointer">Save</button>
                            </form>
                        </div>
                    )}
